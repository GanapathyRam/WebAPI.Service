...
{
    public class OperationMasterSelectCommand : SsDbCommand
    {
        public GetOperationMasterQM Execute()
        {
            var response = new GetOperationMasterQM();
            using (var sqlCommand = CreateCommand())
            {
                sqlCommand.Connection = Connection;
                sqlCommand.CommandText = "[dbo].[uspGetOperationMaster]";
                ...
                {
                    response.GetOperationMasterList = reader.ToList<OperationMasterModel>();
                }
