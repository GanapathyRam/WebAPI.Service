...
{
   public class VendorTermsMasterUpdateCommand : SsDbCommand
    {
        public UpdateVendorTermsMasterQM Execute(UpdateVendorTermsMasterCM model)
        {
            var response = new UpdateVendorTermsMasterQM();
            using (var sqlCommand = CreateCommand())
            {
                sqlCommand.Connection = Connection;
                sqlCommand.CommandText = "[dbo].[uspUpdateVendorTermsMaster]";
