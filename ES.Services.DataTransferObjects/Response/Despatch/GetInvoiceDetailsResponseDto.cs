...
{
    public class GetInvoiceDetailsResponseDto : BaseResponse
    {
        public IEnumerable<SavedInvoiceDetails> GetSavedInvoiceDetailsList { get; set; }
    }

    public class SavedInvoiceDetails
    {
